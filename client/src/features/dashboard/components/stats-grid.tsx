        ...
        return (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className={cn("flex h-8 w-8 items-center justify-center rounded-lg", ACCENT_STYLES[index % ACCENT_STYLES.length])}>
            ...
            <div className="mt-1">
              ...
              {stat.meta ? (
                <p className="mt-1 text-xs text-muted-foreground">
                  {stat.label === "Health" ? formatDateTimeInline(stat.meta) : stat.meta}
                </p>
              ) : null}
            </div>
            {stat.trend.length > 0 ? (
